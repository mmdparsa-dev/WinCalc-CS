...
namespace CalcManager
{
    public static class CCommand
    {
        ...
        public const int IDC_STRING_MAPPED_VALUES = 400;
        public const int IDC_UNARYEXTENDEDFIRST = IDC_STRING_MAPPED_VALUES;
        ...
        public const int IDC_FLOOR = 414; // Floor
        public const int IDC_CEIL = 415;  // Ceiling

        public const int IDC_ROLC = 416; // Rotate Left Circular
        public const int IDC_RORC = 417; // Rotate Right Circular

        public const int IDC_UNARYEXTENDEDLAST = IDC_RORC;

        public const int IDC_LASTCONTROL = IDC_CEIL;

        public const int IDC_BINARYEXTENDEDFIRST = 500;
        public const int IDC_LOGBASEY = 500; // logy(x)
        public const int IDC_NAND = 501;     // Nand
        public const int IDC_NOR = 502;      // Nor

        public const int IDC_RSHFL = 505; // Right Shift Logical
        public const int IDC_BINARYEXTENDEDLAST = IDC_RSHFL;

        public const int IDC_RAND = 600;  // Random
        public const int IDC_EULER = 601; // e Constant
        ...
        public const int IDS_ERR_INVALIDINPUT = 201;
        public const int IDS_ERR_DIVIDEBYZERO = 202;
    }
}
